...
local drawing  = loadstring(syn.request({Url = 'https://raw.githubusercontent.com/zeroday1337x/dopamine/main/canvas/drawing_extension.lua', Method = 'GET'}).Body)()
local tween = loadstring(syn.request({Url = 'https://raw.githubusercontent.com/zeroday1337x/dopamine/main/canvas/custom_tween.lua', Method = 'GET'}).Body)()
